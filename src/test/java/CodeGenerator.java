...
public class CodeGenerator {
    /** JDBC配置，请修改为你项目的实际配置 */
    private static final String JDBC_URL = "jdbc:mysql://10.0.0.250:3306/hzz-guangdong";
    ...
    /** author */
    private static final String AUTHOR = "zhongjiahui";
    /** date */
    ...
    public static void main(String[] args) {
      ...
      /*String[][] arrNames =  {{"wx_news_article", "", "", "String"}};*/

       //String[][] arrNames = {{"md_administrative_region", "", "行政区划", "Integer"}};

        // 多表名
      String[][] arrNames = {
                /*{"wx_auto_reply", "", "自动回复", "String"},
                {"wx_bind_info", null, "用户绑定信息", "String"},
                {"wx_gov_info", null, "政务信息", "String"},
                {"wx_material_file", "", "公众号素材", "String"},
              {"wx_menu_func", "", "微信功能菜单", "Integer"},
              {"wx_subscribe_user", "", "关注用户表", "String"},
              {"wx_template_msg", "", "消息模板", "String"},*/
              {"md_chairmain", "", "河长名单表", "Integer"},
              {"md_site", "", "水位站点表", "String"},
              {"md_site_data", "", "水位数据表", "String"}
        };
        genCode(arrNames);
    }
